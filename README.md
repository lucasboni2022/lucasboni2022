...
| Projeto                                                   | Descrição                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | Repositórios                                                                                                                                              |
| --------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Sistema de Gestão de Pré-Moldados**                     | Sistema web desenvolvido com Front-End em React com TypeScript e comunicação via APIs REST, integrado a um Back-End em Java utilizando o framework Spring Boot, com banco de dados PostgreSQL hospedado em nuvem e configuração por variáveis de ambiente, permitindo uma integração segura e flexível entre os serviços; o Back-End segue a Arquitetura em Camadas (Controller, Service, Repository, Entity, DTO, Security e Enumeration), promovendo organização, manutenibilidade e escalabilidade do código; a aplicação implementa autenticação e autorização stateless com Spring Security e JWT (JSON Web Token), incluindo geração e validação de tokens, controle de acesso por perfis (roles) e criptografia de senhas com BCrypt; o sistema é voltado para gerenciamento de produção e controle de estoque, com serviços orquestrados por Docker Compose, facilitando a execução local e o deploy em ambientes de homologação e produção. | [Ver Projeto →](https://github.com/lucasboni2022/PremolExpert)                                                                                            |
| **Frete Amigo - Plataforma de Gestão Logística e Fretes** | Plataforma web desenvolvida com Front-End em React, utilizando arquitetura baseada em componentes reutilizáveis e integração com APIs REST desenvolvidas em Node.js no Back-End, proporcionando comunicação eficiente entre as camadas da aplicação; possui interface responsiva, gerenciamento de rotas, consumo de requisições assíncronas e organização modular do código, garantindo maior manutenibilidade, escalabilidade e desempenho; implementa autenticação e autorização baseada em JWT (JSON Web Token), permitindo controle seguro de sessões, proteção de rotas e gerenciamento de acesso aos recursos; o sistema foi desenvolvido para digitalizar o processo de cotação, solicitação e gerenciamento de fretes, conectando usuários e serviços de transporte por meio de uma experiência moderna, intuitiva e de fácil utilização.                                                                                                   | [Front-End →](https://github.com/lucasboni2022/-lucasboni2022-frete-amigo-frontend)<br>[Back-End →](https://github.com/lucasboni2022/frete-amigo-backend) |
