...
| **Frete Amigo - Plataforma de Gestão Logística e Fretes ** | Plataforma web desenvolvida com React, utilizando arquitetura baseada em componentes reutilizáveis e integração com APIs REST desenvolvidas em Node.js, proporcionando comunicação eficiente entre frontend e backend; a aplicação possui interface responsiva, gerenciamento de rotas, consumo de requisições assíncronas e organização modular do código, garantindo maior manutenibilidade, escalabilidade e desempenho; o sistema implementa autenticação e autorização baseada em JWT (JSON Web Token), permitindo controle seguro de sessões, proteção de rotas e gerenciamento de acesso aos recursos da aplicação; o sistema foi projetado para digitalizar o processo de cotação, solicitação e gerenciamento de fretes, conectando usuários e serviços de transporte por meio de uma experiência moderna, intuitiva e de fácil utilização. |[Ver: Fron-End →](https://github.com/lucasboni2022/-lucasboni2022-frete-amigo-frontend)  |[Ver: Back-End →](https://github.com/lucasboni2022/frete-amigo-backend)  
